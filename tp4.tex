    ...
    \chapter{Ejercicio 1}
        ...
        \begin{enumerate}[label=\alph*), left=0pt]
            ...
            \item \fs{} Verificar el TVI y TVF la respuesta en ambos dominios.\\
                ...
                %TVI y TVF de la respuesta al escalon unitario
                El valor inicial en el dominio de Laplace esta definido como:
                \begin{equation}
                    \label{tvi.laplace}
                    x_{(0^+)} = \lim_{s \to \infty} s X_{(s)}
                ...
                Para la respuesta al escalon unitario en el dominio de Laplace, el valor inicial es:
                \begin{equation*}
                ...
                Para las diferentes discretizaciones de las respuestas al escalon unitario, tenemos:
              ...
              \begin{table}[h!]
                  ...
                  \begin{minipage}{0.45\textwidth}
                      ...
                      \begin{tabular}{|c|c|c|}
                          ...
                          \textbf{Continua:} & \multicolumn{2}{|c|}{$\lim_{n \to \infty}h_{(n)}=0$} \\ \hline
                          \textbf{Discreta:} & \textbf{Directa} & \textbf{Bilineal} \\ \hline
                          $T=1s$ & $\lim_{n \to \infty}h_{[n]}=0$ & $\lim_{n \to \infty}h_{[n]}=0$\\ \hline
                          $T=0.1s$ & $\lim_{n \to \infty}h_{[n]}=0$ & $\lim_{n \to \infty}h_{[n]}=0$ \\ \hline
                      \end{tabular}
                  \end{minipage}
              ...
              \begin{table}[H]
                  ...
                  \begin{minipage}{0.45\textwidth}
                      ...
                      \begin{tabular}{|c|c|c|}
                          \hline
                          \multicolumn{3}{|c|}{\textbf{TVF}} \\ \hline
                          \textbf{Continua:} & \multicolumn{2}{|c|}{$\lim_{n \to \infty}y_{(n)}=1$} \\ \hline
                          \textbf{Discreta:} & \textbf{Directa} & \textbf{Bilineal} \\ \hline
                          $T=1s$ & $\lim_{n \to \infty}y_{[n]}=0.85$ & $\lim_{n \to \infty}y_{[n]}=1$\\ \hline
                          $T=0.1s$ & $\lim_{n \to \infty}y_{[n]}=e$ & $\lim_{n \to \infty}y_{[n]}=1$ \\ \hline
                      \end{tabular}
                  \end{minipage}
            ...
            \item \fs{} Bosquejar el diagrama de BODE correspondiente para los dos filtros, y determimar $\omega_c$
                ...
                La frecuencia de corte $\omega_c$ es el valor de $\omega$, donde $Z_{(\omega)}$ alcanza su minimo. Esto significa
                que cuando $Z_{(\omega)}$ sea minima, la intensidad sera maxima en ese punto. Si recordamos:
                \begin{equation*}
                    Z_{T(\omega)} = R + j \left(\omega L - \frac{1}{\omega C}\right)\\
                \end{equation*}

                La unica forma de que $Z_{(\omega)}$ alcance su valor minimo, es que la suma de las componentes multiplicadas por
                $\omega$ de cero:
                \begin{gather*}
                    \omega L - \frac{1}{\omega C} = 0\\
                    \omega L = \frac{1}{\omega C}\\
                    \omega^2 = \frac{1}{LC}\\
                    \omega_c = \sqrt{\frac{1}{LC}}\\
                    \omega_c = \sqrt{2} \sfrac{rad}{s} = 0.22 Hz
                \end{gather*}
